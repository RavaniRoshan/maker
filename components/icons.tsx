...
export const DumbbellIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="m21.5 21.5-2.12-2.12" />
    <path d="M3.64 3.64 6 6" />
    <path d="m18 6-3.4 3.4" />
    <path d="m6 18 3.4-3.4" />
    <path d="M17.657 17.657a2 2 0 1 0-2.828-2.828" />
    <path d="m5.343 5.343a2 2 0 1 0-2.828 2.828" />
  </svg>
);
...
export const LeafIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 10 0v5a7 7 0 0 1-7 7h1" />
        <path d="M11 20v-5" />
    </svg>
);
...
export const ChefHatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M19.6 13.1a2.5 2.5 0 0 0-3.1-3.1 2.5 2.5 0 0 0-3.1 3.1 2.5 2.5 0 0 0 3.1 3.1 2.5 2.5 0 0 0 3.1-3.1Z" />
        <path d="M7.5 13.1a2.5 2.5 0 0 0-3.1-3.1 2.5 2.5 0 0 0-3.1 3.1 2.5 2.5 0 0 0 3.1 3.1 2.5 2.5 0 0 0 3.1-3.1Z" />
        <path d="M13.4 5.9a2.5 2.5 0 0 0-3.1-3.1 2.5 2.5 0 0 0-3.1 3.1 2.5 2.5 0 0 0 3.1 3.1 2.5 2.5 0 0 0 3.1-3.1Z" />
    </svg>
);
